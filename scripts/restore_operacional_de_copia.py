...
`test_col_visual_sereno`, `test_cat_visual_sereno` / E20 seguem o repo, não a cópia `.db`.
...
Colaboradores `tests/col_ui_contract.py`; Catálogo `tests/cat_ui_contract.py`.
"""

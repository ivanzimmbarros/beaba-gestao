...
**Ao vivo (E14 + E15):** durante o trabalho da EQUIPE, o mesmo JSON includes **`live_status`**, **`etapas_pendentes`** e **`live_actualizado_iso`**; o **Monitor de Voo** mostra o bloco **STATUS LIVE** no topo com **`streamlit-autorefresh`** (10 s, sempre activo). O Painel `.md` permanece o registo **histórico** nos PCs.

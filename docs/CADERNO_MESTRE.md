...
4. **Catálogo (E06 incremental):** naturezas **Sessão**, **Produto** e **Coworking** com campos específicos e **descritivo** obrigatório; **Ativo/Inativo** por item; listagem na própria página. **Pacote** e **Evento** em fases seguintes. Valores monetários persistidos em **centavos** onde aplicável.

...
- [ ] **E11 — Pré-venda × Agenda (demanda `2026-04-06_E11_pre_venda_agenda`):** Fase **A** em curso — desenho funcional em `docs/governanca/demandas/2026-04-06_E11_pre_venda_agenda/02_desenho_funcional.md`; **aguarda confirmação formal do Diretor** para fechar **PC1**; depois Fase B (desenho lógico), C–F conforme [`FLUXO_SUCESSO_E_FALHA.md`](docs/governanca/FLUXO_SUCESSO_E_FALHA.md).
